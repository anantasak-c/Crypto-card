...
<head>
    ...
    <title data-key="title">Name - Your Crypto Visa Card</title>
    <!-- Chosen Palette: Futuristic Dark (Background: #0a0a0a, Text: #e5e5e5, Primary: #2563eb, Accent: #4f46e5) -->
    <!-- Application Structure Plan: A single-page, vertical scrolling landing page with a new language toggle feature. The structure is designed to guide the user through a classic marketing funnel: Hook (Hero), Explain (How it Works), Detail (Features & Dashboard), Offer (Cards), and Clarify (FAQ). A sticky navigation bar provides constant access to all sections, enhancing usability. This linear flow is intuitive for a product showcase, making it easy for users to understand the value proposition step-by-step without getting lost. -->
    <!-- Visualization & Content Choices: 
        - Report Info: Core product features. Goal: Inform & Compare. Viz/Method: Grid of feature cards with icons. Interaction: Hover effects. Justification: Easily scannable and digestible presentation of key benefits. Library: HTML/Tailwind.
        - Report Info: How the service works. Goal: Explain a process. Viz/Method: A 3-step visual flowchart. Interaction: None, purely informational. Justification: Simplifies a potentially complex process into three clear, memorable steps. Library: HTML/Tailwind.
        - Report Info: "Interactive Dashboard" concept and mobile app image. Goal: Demonstrate user control in a realistic format. Viz/Method: A simulated dashboard section with a doughnut chart (Portfolio) and a line chart (Spending), combined with a mobile app screen mockup. Interaction: Charts are dynamic and illustrative; the app mockup is a visual element. Justification: Builds credibility and visually demonstrates that the product is usable on both desktop and mobile. Library: Chart.js, HTML/Tailwind.
        - Report Info: CTA for app download or contact. Goal: Guide user to next step. Viz/Method: A simple, two-column layout with clear buttons and text. Interaction: Clickable buttons. Justification: Provides a clear call-to-action for users to either engage with the app or get more information. Library: HTML/Tailwind, JS for interactivity.
        - Report Info: FAQ. Goal: Address user questions. Viz/Method: Accordion list. Interaction: Clicking a question toggles the answer's visibility. Justification: Prevents a long, overwhelming wall of text and allows users to find answers to specific questions quickly. Library: JS for interaction. -->
            ...
            <div class="container mx-auto px-6">
                ...
                <div class="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
                    ...
                    <div class="text-center p-8 rounded-2xl glass-effect">
                        ...
                        <p class="text-neutral-300" data-key="step3-text">Use your physical or virtual Name Visa card for online and in-store purchases anywhere Visa is accepted.</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="space-y-4">
                    ...
                    <div class="faq-item border-b border-gray-700 pb-4">
                        ...
                        <div class="answer mt-4 text-neutral-300" data-key="a3">
                            <p>We support over 100 cryptocurrencies, including major assets like Bitcoin (BTC), Ethereum (ETH), Solana (SOL), and a wide range of stablecoins like USDC and USDT. We are constantly expanding our list of supported assets.</p>
                        </div>
                    </div>
                    <!-- FAQ Item -->
                    <div class="faq-item border-b border-gray-700 pb-4">
    ...
    <script>
        const translations = {
            en: {
                ...
                "dashboard-title": "Your Finances, Visualized",
            ...
            ko: {
                ...
                "chart-labels-spending": ['월', '화', '수', '목', '금', '토', '일'],
